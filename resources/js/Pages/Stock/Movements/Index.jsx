...
export default function Index({ auth, stockMovements, farms, selectedFarmId }) {
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
                <div className="flex justify-between items-center">
                    ...
                    {/* Add buttons for Stock In, Stock Out, Adjustment later */}
                </div>
            }
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    <FarmFilter farms={farms} selectedFarmId={selectedFarmId} routeName="stock.movements.index" />
